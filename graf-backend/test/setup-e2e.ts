...
process.env.DB_NAME = process.env.TEST_DB_NAME || 'graf_test_e2e';
process.env.DB_SYNCHRONIZE = 'true';

process.env.FIREBASE_PROJECT_ID = 'graf-test-project';
process.env.FIREBASE_CLIENT_EMAIL =
  'test@graf-test-project.iam.gserviceaccount.com';
