...
LOCAL_DB_CONTAINER_NAME="${LOCAL_DB_CONTAINER_NAME:-prizma-postgres}"
...
echo ""
echo "🔗 Tu aplicación Hermes ahora puede usar los datos de desarrollo:"
echo "   - Backend Hermes: http://localhost:8080"
